...
export function LoginButton({
  ...
  return (
    <MotionLink
      ...
      className={`inline-flex shrink-0 items-center gap-2.5 whitespace-nowrap rounded-full bg-zinc-50 font-medium text-zinc-950 shadow-[0_8px_30px_rgba(56,189,248,0.12)] transition-shadow hover:shadow-[0_8px_40px_rgba(56,189,248,0.2)] cursor-pointer ${
