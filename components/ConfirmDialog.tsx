      ...
      {open && (
        <>
          <motion.div
            ...
            className="fixed inset-0 z-[70] bg-zinc-950/70 backdrop-blur-sm"
          />
          <motion.div
            role="alertdialog"
            aria-modal="true"
            ...
            transition={spring}
            className="fixed inset-x-4 top-1/2 z-[70] mx-auto max-w-xs -translate-y-1/2 rounded-2xl border border-rose-400/20 bg-zinc-900 p-5 shadow-[0_12px_40px_rgba(0,0,0,0.5)] sm:inset-x-0"
          >
